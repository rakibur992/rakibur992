...
<h3 align="center">Software Engineer | Full-Stack • Backend • DevOps</h3>

<p align="center">
  <a href="https://github.com/rakibur992"><img src="https://img.shields.io/github/followers/rakibur992?label=Follow&style=social" alt="GitHub Followers"></a>
...
### 🚀 About Me
- 💻 Software Engineer with 6+ years of experience across full-stack, backend, and DevOps
- 🌐 Comfortable end-to-end — Next.js/React on the frontend, Java/Python/Node.js on the backend
- ☁️ Cloud-native systems: Docker, Kubernetes, CI/CD pipelines, AWS & Azure
- 💡 Frameworks: Next.js, Spring Boot, Django, FastAPI, Flask, Express.js
- 📊 Databases: PostgreSQL, MySQL, MSSQL, MongoDB, Elasticsearch, Redis
